    ...
    return (
        ...
        <nav class="bg-gray-800">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <h1 className="mb-1 text-4xl font-extrabold leading-none tracking-tight text-gray-200 md:text-2xl lg:text-3xl">Anime Arcade</h1>
                ...
                <div class="hidden md:block">
                    ...
                    <a href="/post-listing" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Post A Listing</a>
